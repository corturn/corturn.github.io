...
<p class="lead"><a href="mailto:{{ site.email }}">{{ site.email }}</a></p>
...
<!--
  ...
  GitHub Pages serves static files only, so it can't receive a form
...
<form class="form" action="PASTE_YOUR_FORMSPREE_ENDPOINT_HERE" method="POST">
  ...
  <label for="name">Lorem</label>
  <input type="text" id="name" name="name" required>

  <label for="email">Ipsum</label>
  <input type="email" id="email" name="email" required>

  <label for="message">Dolor sit amet</label>
  <textarea id="message" name="message" rows="6" required></textarea>

  <button class="btn" type="submit">Lorem ipsum</button>
